...
class Evaluator(object):
    ...
    def evaluate(self, data_loader, query, gallery, use_cython = False):
        features, _ = extract_features(self.model, data_loader, print_freq = self.cfg.TEST.PRINT_PERIOD)
        distmat = pairwise_distance(features, query, gallery)
        results = evaluate_all(distmat, query=query, gallery=gallery, use_cython = use_cython)
